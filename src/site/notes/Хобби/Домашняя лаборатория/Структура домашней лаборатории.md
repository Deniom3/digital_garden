...
| [[Хобби/Домашняя лаборатория/Сервер Armbian - не используется\|Сервер Armbian - не используется]] | 192.168.0.137  | TVBox  | Armbian          |
| [[Хобби/Домашняя лаборатория/Сервер NL\|Сервер NL]]                                               | Aeza Niderland | VM     | Ubuntu           |
| [[Хобби/Домашняя лаборатория/Сервер PL\|Сервер PL]]                                               | Procloud PL    | VM     | Ubuntu           |
| [[Хобби/Домашняя лаборатория/Сервер SPB\|Сервер SPB]]                                             | Selectlc SPB   | VM     | Ubuntu           |
