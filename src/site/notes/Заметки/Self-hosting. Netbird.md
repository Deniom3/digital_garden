---
{"dg-publish":true,"permalink":"/zametki/self-hosting-netbird/","created":"2025-04-20 03:48","updated":"2025-12-04T13:54:27+03:00"}
---
...
### Проксирование сайтов с локального сервера на ноду

- [ ] Описать проксирование сайтов через netbird ➕ 2025-12-04
...
> [!description]- Примечание
> Примечание:: Транспортная vpn сеть для организации связи между серверами
