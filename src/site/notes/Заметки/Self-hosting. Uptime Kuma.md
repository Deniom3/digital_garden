---
{"dg-publish":true,"permalink":"/zametki/self-hosting-uptime-kuma/","created":"2024-09-08 02:40","updated":"2025-11-07T10:20:39+03:00"}
---
...
### Изменение дизайна страницы статусов

При создании страницы статусов в настройках можно переопределить css настройки для отображаемой информации. 

Пример таких настроек: [cute-kuma/main.css at main · dermv/cute-kuma · GitHub](https://github.com/dermv/cute-kuma/blob/main/main.css)
```css
/* GLOBALS
-------------------------------------------------- */
